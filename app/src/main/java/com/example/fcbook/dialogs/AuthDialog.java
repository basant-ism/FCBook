package com.example.fcbook.dialogs;
...
public class AuthDialog  extends Dialog {
    ...
    public AuthDialog(@NonNull Context context,String mealId) {
        super(context);
        this.mealId=mealId;
    }
                            ...
                            db.collection("users").document(mAuth.getUid()).get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                                ...
                                public void onSuccess(DocumentSnapshot documentSnapshot) {
                                    if(documentSnapshot.exists()) {
                                        ...
                                        List<String> meals_ids = user.getMeals_id();
                                        if (meals_ids != null) {
                                            if (!meals_ids.contains(mealId)) {
                                                meals_ids.add(mealId);
                                                HashMap<String, Object> hashMap = new HashMap<>();
                                                hashMap.put("meals_id", meals_ids);
